 ...
 * @author Cecilia
 */
public class ModificarDatosEstudiante extends javax.swing.JPanel {
    private Estudiante estudianteActual;

    public ModificarDatosEstudiante() {
        initComponents();
   ...
   boolean flag = false;
        ...
        JOptionPane.showMessageDialog(null, "Numero Vacio o incorrecto");     
        flag = true;
        ...
        if (!flag){
            ...
            servicioEstudiante.actualizarDatos(estudianteActual.getNombreUsuario() , email.getText(), telefonoLong);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ServicioEstudiante servicioEstudiante = new ServicioEstudiante();
        try {
            servicioEstudiante.eliminarEstudiante(estudianteActual.getNombreUsuario());
